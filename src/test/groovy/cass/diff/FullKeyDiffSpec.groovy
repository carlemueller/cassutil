...
class FullKeyDiffSpec extends Specification {
    ...
    void 'test pk diff'() {
        ...
        FullKeyDiff diff = new FullKeyDiff(
        ...
        then:
        diffReport.find{it.key == [100000L, 'group1', 'name1', 'jobtype1'] as Object[]}.side == "LEFT"
        diffReport.find{it.key == [100000L, 'group1', 'name1', 'jobtype2'] as Object[]} == null
